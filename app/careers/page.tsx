...
export default function CareersPage() {
  return <><Navbar theme="light" /><main>
    ...
    <section className="mx-auto grid w-full max-w-400 grid-cols-12 gap-8 px-12 pb-24 max-lg:grid-cols-1 max-md:px-6 max-md:pb-16">
      <div className="col-span-4"><SectionEyebrow>Open roles</SectionEyebrow><h2 className="mt-3 max-w-sm text-3xl font-medium leading-9 text-text-primary">Find the next question worth working on.</h2></div>
