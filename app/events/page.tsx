...
const PAST_EVENTS = [
  {
    ...
    location: "Lagos",
    description:
      "A closed working session on identity, payments and the institutional decisions that determine whether shared digital systems earn trust.",
  ...
  },
  {
    ...
    location: "Nairobi",
    description:
      "A practical discussion for operators and investors on sequencing regulation, partnerships, product adaptation and local authority.",
      ...
      <main>
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="grid min-h-96 place-items-center rounded-xs border border-border-secondary bg-bg-primary px-8 py-16 text-center">
              <div className="flex max-w-xl flex-col items-center">
                <div
                  className="flex size-14 items-center justify-center rounded-xs border border-border-primary bg-bg-secondary text-text-brand-tertiary shadow-xs"
                  aria-hidden="true"
                >
                  <Calendar size={24} />
                </div>
                ...
                <div className="mt-6">
                  <Button href="/contact" variant="primary-alt" size="lg">
                    Register your interest
                  </Button>
                </div>
                <p className="mt-4 text-xs leading-4.5 text-text-quaternary">
                  Conceptual event programme. No registration is submitted.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mx-auto grid w-full max-w-400 grid-cols-12 gap-8 px-12 py-24 max-lg:grid-cols-1 max-md:px-6 max-md:py-16">
          <div className="col-span-4">
            <SectionEyebrow>How we convene</SectionEyebrow>
          </div>
          <div className="col-span-8 grid grid-cols-2 gap-8 max-md:grid-cols-1">
            {[
              [
                "Small enough for useful exchange",
                "We favour focused rooms where participants can test assumptions and speak from direct experience.",
              ],
              [
                "Structured around a decision",
                "Each session begins with a practical question and ends with implications participants can take back into their work.",
              ],
              [
                "Clear about the format",
                "Public briefings, closed roundtables and working sessions have different expectations. We state those boundaries upfront.",
              ],
              [
                "Evidence before performance",
                "The purpose is to improve understanding, not to create a stage or fill a calendar.",
              ],
            ].map(([title, copy]) => (
