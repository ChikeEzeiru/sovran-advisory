        ...
        <section className="mx-auto w-full max-w-400 px-12 pb-16 max-md:px-4 max-md:pb-12">
          <div className="border-t border-border-primary pt-16">
            <div className="max-w-3xl">
              <h2 className="text-2xl max-md:text-xl max-md:leading-7.5 font-medium leading-8 tracking-tight text-text-secondary">
                Leadership that stays involved
              </h2>
              <p className="mt-2 text-lg max-md:text-base max-md:leading-6 leading-7 text-text-secondary">
