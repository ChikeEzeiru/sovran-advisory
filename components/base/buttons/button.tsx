...
export const styles = sortCx({
    ...
    sizes: {
        ...
        lg: {
            root: "gap-1.5 rounded-[2px] px-4 py-2.5 text-md font-semibold before:rounded-[1px] data-icon-only:p-3",
            linkRoot: "gap-1.5 *:data-text:underline-offset-4",
        },
        xl: {
            root: "gap-1.5 rounded-[2px] px-4.5 py-3 text-md font-semibold before:rounded-[1px] data-icon-only:p-3.5",
            linkRoot: "gap-1.5 *:data-text:underline-offset-4",
        },
    },
    ...
    colors: {
        ...
        "primary-destructive": {
            root: [
                "bg-error-solid text-white shadow-xs ring-1 ring-transparent outline-error ring-inset hover:bg-error-solid_hover data-loading:bg-error-solid_hover",
                // Inner border gradient
                "before:absolute before:inset-px before:border before:border-white/12 before:mask-b-from-0%",
                // Icon styles
                "*:data-icon:text-white/60 hover:*:data-icon:text-white/70",
        ...
        "secondary-destructive": {
            root: [
                "bg-primary text-error-primary shadow-xs ring-1 ring-error_subtle outline-error ring-inset hover:bg-error-primary hover:text-error-primary_hover data-loading:bg-error-primary",
                // Icon styles
